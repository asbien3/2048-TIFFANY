...
function caption(exp) {
  var caption = [];
  caption[2]    = 'ciondolo piastrina a cuore';
  caption[4]    = 'ciondolo a cuore';
  caption[8]    = 'bracciale di perle';
  caption[16]   = 'bracciale love Paloma Picasso';
  caption[32]   = 'anello cocktail in ametista';
  caption[64]   = 'anello Sommerset in oro rosa';
  caption[128]  = 'orecchini lunghi Hearths';
  caption[256]  = 'orecchini a cerchio rope';
  caption[512]  = 'collana a sciarpa Mesh';
  caption[1024] = 'bracciale stretto Schlunberger';
  caption[2048] = 'collana di diamanti';
...
GameManager.prototype.fillLegend = function () {
  ...
  for (var i = 1; i <= 11; i++) {
    ...
    p.innerHTML = caption(exp) + "<br>" + prezzo(exp) + ' &euro;';
    row.appendChild(p);
